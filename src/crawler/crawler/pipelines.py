...
def build_crawl_attempt_payload(
    *,
    ...
    return {
        ...
        "tier": item.get("tier"),
        "politeness_key": item.get("politeness_key"),
        "policy_scope_id": item.get("policy_scope_id"),
        "policy_version": item.get("policy_version"),
        "matched_policy_scope_type": item.get("matched_policy_scope_type"),
        "matched_policy_scope_id": item.get("matched_policy_scope_id"),
        "policy_lkg_active": item.get("policy_lkg_active"),
