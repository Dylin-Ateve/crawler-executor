...
export KAFKA_PRODUCER_RETRIES="${P1_FAILURE_KAFKA_PRODUCER_RETRIES:-1}"
export KAFKA_REQUEST_TIMEOUT_MS="${P1_FAILURE_KAFKA_REQUEST_TIMEOUT_MS:-3000}"
export KAFKA_DELIVERY_TIMEOUT_MS="${P1_FAILURE_KAFKA_DELIVERY_TIMEOUT_MS:-6000}"
export KAFKA_FLUSH_TIMEOUT_MS="${P1_FAILURE_KAFKA_FLUSH_TIMEOUT_MS:-8000}"
