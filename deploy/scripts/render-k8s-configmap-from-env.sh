...
CONFIG_KEYS = [
    ...
    ("runtime_policy_provider", "RUNTIME_POLICY_PROVIDER", "file"),
    ("runtime_policy_file", "RUNTIME_POLICY_FILE", "/etc/crawler/runtime/runtime_policy.json"),
    ("runtime_policy_reload_interval_seconds", "RUNTIME_POLICY_RELOAD_INTERVAL_SECONDS", "5"),
    ("runtime_policy_lkg_max_age_seconds", "RUNTIME_POLICY_LKG_MAX_AGE_SECONDS", "3600"),
    (
        "runtime_policy",
        "RUNTIME_POLICY_DOCUMENT",
        '{"schema_version":"1.0","version":"policy-bootstrap","generated_at":"2026-05-03T10:00:00Z","default_policy":{"enabled":true,"paused":false,"egress_selection_strategy":"STICKY_POOL","sticky_pool_size":4,"host_ip_min_delay_ms":2000,"host_ip_jitter_ms":500,"download_timeout_seconds":30,"max_retries":2,"max_local_delay_seconds":300}}',
    ),
