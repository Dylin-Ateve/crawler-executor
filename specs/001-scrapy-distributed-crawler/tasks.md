...
- [ ] T025 Step 6 Redis 黑名单 TTL 端到端验证。当前暂未验证。
- [ ] T026 Step 9/10 短时与 24 小时稳定性测试。当前按计划后置。
- [ ] T027 将 P0 结果与当前 Heritrix 基线对比。当前暂不定义补充指标，等待稳定性数据。
- [ ] T028 决定是否进入 P1 存储与 Kafka 实现。
